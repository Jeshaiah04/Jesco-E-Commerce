				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="<?php echo e(asset('http://127.0.0.1:8000/storage/photos/6/Jesco Logo V1.png')); ?>" alt="#"></a>
							</div>
							<?php
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> Jesco. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
...
<?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>