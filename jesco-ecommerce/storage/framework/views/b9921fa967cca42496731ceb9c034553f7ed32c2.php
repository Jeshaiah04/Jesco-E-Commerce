<?php $__env->startSection('title','JESCO || PRODUCT PAGE'); ?>
                                    ...
                                    <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                ?>
                                                <p class="price"><del class="text-muted">Rp<?php echo e(number_format($product->price,2)); ?></del>   Rp<?php echo e(number_format($org,2)); ?>  </p>
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								<?php if(count($products)): ?>
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																<del>Rp<?php echo e(number_format($product->price,2)); ?></del>
															</div>
									...
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php else: ?>
									<h4 class="text-warning" style="margin:100px auto;">There are no products here!</h4>
								<?php endif; ?>
							</div>
							 <div class="row">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>