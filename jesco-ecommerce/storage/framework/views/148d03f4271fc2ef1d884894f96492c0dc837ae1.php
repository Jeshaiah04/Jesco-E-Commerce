<?php $__env->startSection('title','JESCO || HOME PAGE'); ?>
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item <?php echo e((($key==0)? 'active' : '')); ?>">
                    ...
                    <div class="carousel-caption d-none d-md-block text-left">
                        ...
                        <a class="btn btn-lg ws-btn wow fadeInUpBig" href="<?php echo e(route('product-grids')); ?>" role="button">Shop Now<i class="far fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
                    ...
                    <?php if($cat->is_parent==1): ?>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="single-banner">
                                <?php if($cat->photo): ?>
                                    <img class="rounded frame" src="<?php echo e($cat->photo); ?>" alt="<?php echo e($cat->photo); ?>">
                                <?php else: ?>
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                ?>
                                <?php if($categories): ?>
                                <button class="btn" style="background: #002752"data-filter="*">
                                    All Products
                                </button>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <button class="btn my-1" style="background:none;color:black;"data-filter=".<?php echo e($cat->id); ?>">
                ...
                <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            ?>
                            <img class="rounded" src="<?php echo e($photo[0]); ?>" alt="<?php echo e($photo[0]); ?>">
                            <div class="content">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/frontend/index.blade.php ENDPATH**/ ?>