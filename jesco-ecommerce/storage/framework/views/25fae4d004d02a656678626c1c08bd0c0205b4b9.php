<?php $__env->startSection('title','JESCO || DASHBOARD'); ?>
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(\App\Models\Category::countActiveCategory()); ?></div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(\App\Models\Product::countActiveProduct()); ?></div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                    <div class="h5 mb-0 mr-3 font-weight-bold text-white"><?php echo e(\App\Models\Order::countActiveOrder()); ?></div>
                  </div>
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-white"><?php echo e(\App\Models\Post::countActivePost()); ?></div>
              </div>
              <div class="col-auto">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/backend/index.blade.php ENDPATH**/ ?>