                                    ...
                                    <ul class="shopping-list">
                                            ...
                                            <?php $__currentLoopData = Helper::getAllProductFromWishlist(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <p class="quantity"><?php echo e($data->quantity); ?> x - <span class="amount">Rp<?php echo e(number_format($data->price,2)); ?></span></p>
                                                    </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">Rp<?php echo e(number_format(Helper::totalWishlistPrice(),2)); ?></span>
                                        </div>
                                        <a href="<?php echo e(route('cart')); ?>" class="btn animate" style="color: #fff; background: #002752">Cart</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <!--/ End Shopping Item -->
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">Rp<?php echo e(number_format(Helper::totalCartPrice(),2)); ?></span>
                                        </div>
                                        <a href="<?php echo e(route('checkout')); ?>" class="btn animate" style="color: #fff; background: #002752">Checkout</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <!--/ End Shopping Item -->
...
<?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>