								...
								<?php if(Helper::getAllProductFromCart()): ?>
									<?php $__currentLoopData = Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td class="price" data-title="Price"><span>Rp<?php echo e(number_format($cart['price'],2)); ?></span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">Rp<?php echo e($cart['amount']); ?></span></td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="<?php echo e(Session::get('coupon')['value']); ?>">You Save<span>Rp<?php echo e(number_format(Session::get('coupon')['value'],2)); ?></span></li>
										<?php endif; ?>
										<?php
										...
										?>
										<?php if(session()->has('coupon')): ?>
											<li class="last" id="order_total_price">You Pay<span>Rp<?php echo e(number_format($total_amount,2)); ?></span></li>
										<?php else: ?>
											<li class="last" id="order_total_price">You Pay<span>Rp<?php echo e(number_format($total_amount,2)); ?></span></li>
										<?php endif; ?>
									</ul>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>