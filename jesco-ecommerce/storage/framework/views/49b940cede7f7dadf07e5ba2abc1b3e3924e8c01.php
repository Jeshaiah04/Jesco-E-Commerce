...
unset($__errorArgs, $__bag); ?>
                        ...
                        <button type="submit" class="btn btn-success btn-sm my-2">Update</button>
                </form>
            </div>
        </div>
   </div>
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/user/users/profile.blade.php ENDPATH**/ ?>