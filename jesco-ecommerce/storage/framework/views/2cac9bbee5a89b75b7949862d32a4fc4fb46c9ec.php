<nav class="navbar navbar-expand navbar-nav bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="mr-3 d-none d-lg-inline text-blue-500 font-weight-bold"><?php echo e(Auth()->user()->name); ?></span>
...
<?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/backend/layouts/header.blade.php ENDPATH**/ ?>