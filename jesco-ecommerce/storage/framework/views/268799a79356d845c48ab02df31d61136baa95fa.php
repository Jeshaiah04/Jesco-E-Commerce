            ...
            <div class="order-info">
              ...
              <table class="table">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td>Coupon</td>
                      <td> : Rp <?php echo e(number_format($order->coupon,2)); ?></td>
                    </tr>
                    <tr>
                        <td>Total Amount</td>
                        <td> : Rp <?php echo e(number_format($order->total_amount,2)); ?></td>
                    ...
                    <tr>
                        ...
                        <td> : <?php if($order->payment_method=='WhatsApp'): ?> WhatsApp <?php endif; ?></td>
                    </tr>
                    <tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\jesco-ecommerce\resources\views/backend/order/show.blade.php ENDPATH**/ ?>