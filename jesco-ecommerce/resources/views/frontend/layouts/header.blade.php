                            ...
                            @auth
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{route('cart')}}" class="btn animate" style="color: #fff; background: #002752">Cart</a>
                                    </div>
                                </div>
                            @endauth
                            <!--/ End Shopping Item -->
                            ...
                            @auth
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{route('checkout')}}" class="btn animate" style="color: #fff; background: #002752">Checkout</a>
                                    </div>
                                </div>
                            @endauth
                            <!--/ End Shopping Item -->
