                    ...
                    @if($cat->is_parent==1)
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="single-banner">
                                @if($cat->photo)
                                    <img class="rounded frame" src="{{$cat->photo}}" alt="{{$cat->photo}}">
                                @else
                        ...
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                <button class="btn" style="background: #002752"data-filter="*">
                                    ...
                                    <button class="btn my-1" style="background:none;color:black;"data-filter=".{{$cat->id}}">
                                        {{$cat->title}}
                                    </button>
                                    @endforeach
                                @endif
                ...
                @foreach($featured as $data)
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            @endphp
                            <img class="rounded" src="{{$photo[0]}}" alt="{{$photo[0]}}">
                            <div class="content">
